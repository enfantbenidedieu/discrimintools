...
#intern functions
from ..discriminant_analysis.functions.utils import check_is_dataframe, check_is_series
from ..discriminant_analysis.functions.expand_grid import expand_grid

class _BaseHPDA(TransformerMixin,ClassifierMixin,BaseEstimator):
    """
    Base class for Discriminant Analysis methods
    ---------------------------------------------
    This class inherits from sklearn ``TransformerMixin``, ``ClassifierMixin`` and ``BaseEstimator`` classes.
    ...
    Use the other classes of the package (HPCANDISC, HPDISCRIM, DiCA, LDAPC, MDA, CPLS, PLSDA & PLSLDA), which inherit
