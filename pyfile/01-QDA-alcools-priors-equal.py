...
#subtitle: equal priors probabilities
#authors: Duvérier DJIFACK ZEBAZE
#email: djifacklab@gmail.com
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------
print("\nQuadratic Discriminant Analysis with Equal Priors Probabilities\n")
...
#instanciation
clf = DISCRIM(method="quad",priors="equal")
...
print(clf.cov_.infos)

print("\nTest of equality of variance:")
print(clf.cov_.test.round(3))
...
print(clf.statistics_.manova.round(4))
...
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------
#evaluation of prediction on testing data
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------
